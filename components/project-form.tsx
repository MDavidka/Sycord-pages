...
export function ProjectForm({ onSubmit }: ProjectFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    domain: "",
    subdomain: "",
    selectedStyle: "modern", // Default style, hidden from user now
    status: "pending",
  })
        ...
        return (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300 max-w-md mx-auto">
             <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground text-sm mt-1">Ez jelenik majd meg a fejlécben és a SEO leírásokban</p>
             </div>
        ...
        return (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300 max-w-md mx-auto">
             <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold">Csatlakozás & Publikálás</h2>
                <p className="text-muted-foreground text-sm mt-1">Utolsó lépés: kapcsold össze Vercel fiókod a publikáláshoz</p>
             </div>
            ...
            <div className="space-y-4">
                ...
                <div className="pt-4">
                    ...
                    >
                        {isVercelConnected ? "Weboldal Létrehozása" : "Kérlek jelentkezz be fentebb"}
                    </Button>
                    {!isVercelConnected && (
                        <p className="text-xs text-center text-muted-foreground mt-2">
                            A publikáláshoz szükséges a Vercel integráció
                        </p>
                    )}
                </div>
            </div>
  ...
  const isStepValid = () => {
    switch (currentStep) {
      ...
      case 4:
        return true // Validation handled by disabled button
      default:
        return false
    }
  }
