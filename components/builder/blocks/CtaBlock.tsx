  ...
  return (
    <section className="px-6 @md:px-10 py-16 @md:py-20 text-center relative overflow-hidden">
      ...
      <div className="relative z-10">
        <h2 className="reveal-fade-up reveal-d1 text-2xl @md:text-3xl font-bold tracking-tight mb-3">{props.headline}</h2>
        {props.subheadline && (
          <p className="reveal-fade-up reveal-d2 text-text-2 text-sm mb-6 max-w-md mx-auto">{props.subheadline}</p>
        )}
  ...
  return (
    <section className="px-6 @md:px-10 py-12 @md:py-16">
      <div className="reveal-scale reveal-d1 flex flex-col @lg:flex-row items-center justify-between gap-6 p-8 rounded-xl bg-bg-2 border border-border-default relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-xl @md:text-2xl font-bold tracking-tight mb-1">{props.headline}</h2>
          {props.subheadline && <p className="text-text-2 text-sm">{props.subheadline}</p>}
        </div>
