    ...
    <div className="px-6 py-12 @lg:px-16 @lg:py-16">
      ...
      {embedUrl ? (
        <div className="reveal-scale reveal-d2 w-full aspect-video rounded-lg overflow-hidden border border-border-default">
          <iframe src={embedUrl} title={title || "Video"} className="w-full h-full" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
        </div>
      ) : (
        <Placeholder />
      )}
