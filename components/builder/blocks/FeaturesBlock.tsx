...
import { Blocks, Code, Bot, Zap, Shield, Globe, Layers, Palette, Rocket, Star, Lock, Settings } from "lucide-react"
...
const iconMap: Record<string, LucideIcon> = {
  Blocks, Code, Bot, Zap, Shield, Globe, Layers, Palette, Rocket, Star, Lock, Settings,
}
  ...
  return (
    <section className="px-6 @md:px-10 py-16 @md:py-20">
      <div className="reveal-fade-up reveal-d1 text-center mb-10">
        {props.label && (
          <div className="text-[11px] font-semibold uppercase tracking-widest text-green mb-2">{props.label}</div>
        )}
