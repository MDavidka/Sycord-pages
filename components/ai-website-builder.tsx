...
import { Loader2, ChevronDown, FileCode, ArrowRight, CheckCircle2, Folder, FolderOpen, ChevronRight, Code, Bug, Layout, Send, Zap, Globe, Database, ThumbsUp, ThumbsDown, Flag, Plus, Paperclip, X, Coins, Gem } from "lucide-react";
...
| "done" | "fixing"; // Auto-fix compatibility
...
}: {phase: GenerationPhase;progress: {percent: number;done: number;total: number;};currentFile?: string;}) => {
...
},
{
  ...
  logo: "https://img.rocket.new/generatedImages/rocket_gen_img_1ff85c53f-1772837116654.png",
  color: "#3ECF8E",
...
},
{
  ...
  placeholder: "AIzaSy...",
  logo: "https://img.rocket.new/generatedImages/rocket_gen_img_1bb04ce25-1767098518713.png",
  color: "#FFCA28",
...
}: {input: string;setInput: (v: string) => void;onSend: () => void;disabled: boolean;selectedModel: ModelOption;setSelectedModel: (m: ModelOption) => void;attachments: File[];setAttachments: React.Dispatch<React.SetStateAction<File[]>>;credits: number | null;bestCost: number;fastCost: number;}) => {
          ...
          <div className="flex items-center justify-between gap-1.5 sm:gap-2 px-0.5">
                  ...
                  <Button
                    ...
                    <span
                      className={cn(
                        ...
                        selectedTier === "fast" ? "bg-yellow-400/10 text-yellow-300" : "bg-violet-400/10 text-violet-300"
                      )}>
            ...
            <Button
              ...
              className={cn(
                ...
                "bg-white text-black hover:bg-zinc-200" : "bg-zinc-800/50 text-zinc-700"
              )}
...
}: {model: ModelOption;selected: boolean;onSelect: () => void;tier: ModelTier;}) =>
<DropdownMenuItem
  onClick={onSelect}
  className={cn(
...
}: {projectId: string;onConnect: () => void;}) => {
            ...
            <div
              ...
              <>
                    ...
                    className={cn(
                      ...
                      "text-zinc-200" : "text-zinc-700 hover:text-zinc-400"
                    )}>
                    ...
                    className={cn(
                      ...
                      "text-red-400" : "text-zinc-700 hover:text-zinc-400"
                    )}>
