          ...
          <CardContent className="pt-4 space-y-5">
            <PipelineStep
              ...
              description={[
                ...
                "The AI's model profile (syra-nano / syra-base / syra-havy / syra-ultra) determines which LLM provider is used: Gemini Flash, DeepSeek V4 Flash, Gemini Pro, or DeepSeek V4 Pro.",
