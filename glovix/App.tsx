...
function ChatPage() {
    ...
    if (accessDenied) {
        return (
            <div className="h-screen w-screen flex flex-col items-center justify-center bg-[var(--background)] p-4">
...
function AppContent() {
    ...
    if (loading) {
        return (
            <div className={`h-screen w-screen flex flex-col items-center justify-center ${isDark ? 'bg-[var(--background)]' : 'bg-white'}`}>
