                                        ...
                                        if (seg.type === 'text' && seg.content) {
                                            ...
                                            return (
                                                <div key={`seg-${segIdx}`} className="flex justify-start max-w-full">
                                                    <div className={`text-[14px] leading-relaxed max-w-[85%] sm:max-w-[75%] overflow-hidden break-words rounded-2xl px-3 py-2 ${isDark ? 'text-white/80 bg-white/[0.02] border border-white/[0.03]' : 'text-gray-700 bg-gray-50/60 border border-gray-200/30'}`}>
                                    ...
                                    <div className={`flex ${group.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                        <div
                                            className={`text-[14px] leading-relaxed ${
                                                group.role === 'user'
                                                    ? isDark
                                                        ? 'bg-white/[0.04] text-white/85 rounded-2xl px-4 py-2.5 max-w-[85%] sm:max-w-[75%] border border-white/[0.04] overflow-hidden break-words'
                                                        : 'bg-gray-100/80 text-gray-800 rounded-2xl px-4 py-2.5 max-w-[85%] sm:max-w-[75%] border border-gray-200/50 overflow-hidden break-words'
                                                    : isDark
                                                        ? 'text-white/80 max-w-[85%] sm:max-w-[75%] bg-white/[0.02] rounded-2xl px-3 py-2 border border-white/[0.03] overflow-hidden break-words'
                                                        : 'text-gray-700 max-w-[85%] sm:max-w-[75%] bg-gray-50/60 rounded-2xl px-3 py-2 border border-gray-200/30 overflow-hidden break-words'
                                            }`}
                                        >
