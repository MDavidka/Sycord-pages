...
export function EmbeddedChat() {
    ...
    const renderPreviewBody = () => {
        if (previewUrl) {
            ...
            if (!embedInline) {
                return (
                    <div className={`flex h-full flex-col items-center justify-center gap-4 px-6 text-center ${isDark ? 'bg-[#181818] text-[#9a9b9e]' : 'bg-gray-50 text-gray-500'}`}>
                        ...
                        <a
                            ...
                            className={`rounded-lg px-4 py-2 text-sm font-medium ${isDark ? 'bg-white text-[#181818] hover:bg-white/90' : 'bg-gray-900 text-white hover:bg-gray-800'} transition-colors`}
                        >
                            Open live site
                        </a>
                        <button
            ...
            return (
                <>
                    {previewSource === 'deployed' && (
                        <div className={`absolute left-0 right-0 top-0 z-10 border-b px-3 py-1.5 text-center text-[11px] ${isDark ? 'border-[#2a2b2e] bg-[#181818]/90 text-[#9a9b9e]' : 'border-gray-200 bg-gray-50/95 text-gray-500'}`}>
                            {pendingDeploy
                    ...
                    {previewSource === 'syte' && (
                        <div className={`absolute left-0 right-0 top-0 z-10 border-b px-3 py-1.5 text-center text-[11px] flex items-center justify-center gap-1.5 ${isDark ? 'border-[#2a2b2e] bg-[#181818]/90 text-[#9a9b9e]' : 'border-gray-200 bg-gray-50/95 text-gray-500'}`}>
        ...
        if (previewStatus === 'starting') {
            return (
                <div className={`flex h-full flex-col items-center justify-center gap-3 px-6 text-center ${isDark ? 'bg-[#181818] text-[#9a9b9e]' : 'bg-gray-50 text-gray-400'}`}>
        ...
        if (previewStatus === 'blocked' || previewStatus === 'error') {
            return (
                <div className={`flex h-full flex-col items-center justify-center gap-3 px-6 text-center ${isDark ? 'bg-[#181818] text-[#9a9b9e]' : 'bg-gray-50 text-gray-500'}`}>
    ...
    const renderPreviewHeader = () => (
        <div className={`flex h-11 flex-shrink-0 items-center gap-1.5 border-b px-2 ${isDark ? 'border-[#222226] bg-[#181818]' : 'border-gray-200 bg-white'}`}>
            {/* Back to chat */}
            <button
                onClick={() => goToPane(0)}
            ...
            {previewHost ? (
                <button
                    ...
                    title={previewUrl || ''}
                    className={`flex min-w-0 flex-1 items-center gap-1.5 rounded-md px-2 py-1 text-[11px] transition-colors ${isDark ? 'bg-[#222226] text-[#c5c6c9] hover:bg-[#2c2c30]' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                >
                ...
                <div className={`flex min-w-0 flex-1 items-center gap-1.5 rounded-md px-2 py-1 text-[11px] ${isDark ? 'bg-[#222226] text-[#666]' : 'bg-gray-100 text-gray-400'}`}>
                    {workspaceStatus === 'creating' ? (
                        <>
