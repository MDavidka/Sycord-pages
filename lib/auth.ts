...
export const authOptions: AuthOptions = {
  providers: [
    ...
    // Custom Vercel Provider - Manually Configured
    {
      id: "vercel",
      name: "Vercel",
      type: "oauth",
      ...
      // Important: Vercel expects params in body, client_secret_post handles this.
      // However, we remove 'checks' to allow NextAuth default state handling without strict PKCE if that was failing,
      // though Vercel supports it. We'll simplify to just 'state'.
      client: {
