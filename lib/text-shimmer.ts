...
export const TEXT_SHIMMER_CLASS_NAME =
  "beui-text-shimmer bg-[length:200%_100%] bg-clip-text text-transparent bg-[linear-gradient(110deg,var(--muted-foreground,rgba(255,255,255,0.45))_30%,var(--foreground,#fff)_50%,var(--muted-foreground,rgba(255,255,255,0.45))_70%)]";
