...
function Hero() {
  return (
    <section
      className="relative flex min-h-[100dvh] w-full flex-col overflow-hidden md:min-h-0 md:overflow-visible"
      style={{
        backgroundColor: "#0a0a0a",
        backgroundImage:
          "radial-gradient(ellipse 80% 55% at 50% 0%, #161616 0%, #0a0a0a 70%)",
      }}
    >
      {/* Header */}
      <header className="relative z-20 mx-auto flex w-full max-w-6xl items-center justify-between px-5 pt-5 sm:px-8 sm:pt-7">
        ...
        <Link
          href="/login"
          className="rounded-full border border-white/20 px-4 py-1.5 text-sm font-medium lowercase tracking-tight text-white transition-colors hover:border-white/35 hover:bg-white/5"
        >
          sign in
        </Link>
      </header>
      ...
      {/* Headline */}
      <div className="relative z-20 mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-5 pb-2 pt-10 text-center md:flex-none md:pb-4 md:pt-16">
        <h1
        ...
        >
          <span className="inline-flex flex-wrap items-center justify-center gap-x-2.5 gap-y-2">
            <span>The</span>
            <span className="inline-flex items-center rounded-full bg-[#1f1f1f] px-3.5 py-1 sm:px-4 sm:py-1.5">
              Cloud Coding
            </span>
          </span>
          <br />
