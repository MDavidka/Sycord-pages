...
- This Style call produces ONLY the current route body.
- Do NOT render a site-wide header, footer, or nav in this JSON tree.
- The generated project already includes a manifest-driven <SiteNav /> shell.
- Match this page's spacing, density, and tone to manifest.chrome.navVariant and manifest.chrome.pageRhythm.
