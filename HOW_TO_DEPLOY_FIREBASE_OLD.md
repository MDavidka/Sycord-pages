...
1. **Create Account**: Go to https://dash.cloudflare.com/ and sign up for free
2. **Get Account ID**:
   - Log in to your dashboard
   - Your Account ID appears in the URL or sidebar
   - Example: `dash.cloudflare.com/12345abc...`
3. **Create API Token**:
